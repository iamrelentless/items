...
sudo dnf install -y cmake automake llvm clang gcc gdb yasm nasm valgrind wireguard-tools nmap ranger neovim zsh zsh-syntax-highlighting zsh-autosuggestions python3-pip p7zip-plugins unzip tmux rsync curl wget  awscli
...
### WS
# gui-packages
# sudo dnf install -y flatpak discord obs-studio piper solaar 
...
# CLion, Pycharm, Go and other Intellij Products  -> creds
